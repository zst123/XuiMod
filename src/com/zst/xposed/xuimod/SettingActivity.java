...
public class SettingActivity extends PreferenceActivity implements OnPreferenceClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(!prefs.contains(FIRST_KEY))  prefs.edit().putBoolean(FIRST_KEY, false).commit(); // make a new preference so "MODE WORLD READABLE" works
	...
	private void killPackage(String packageToKill) { //code modified from : http://forum.xda-developers.com/showthread.php?t=2235956&page=6  
		try {  // get superuser 
	...
	private void listViewTester(){
      ...
      ArrayAdapter<String> modeAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, android.R.id.text1);
